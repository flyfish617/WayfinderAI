...
# HF_ENDPOINT 等环境变量必须在导入 huggingface_hub / sentence_transformers 之前设置，
# 否则镜像配置不生效（huggingface_hub 在导入时读取 HF_ENDPOINT）
if settings.HF_ENDPOINT:
    os.environ.setdefault("HF_ENDPOINT", settings.HF_ENDPOINT)
if settings.HF_HUB_OFFLINE:
    os.environ.setdefault("HF_HUB_OFFLINE", str(settings.HF_HUB_OFFLINE))
if settings.HF_HUB_CACHE_DIR:
    os.environ.setdefault("HF_HUB_CACHE_DIR", settings.HF_HUB_CACHE_DIR)
